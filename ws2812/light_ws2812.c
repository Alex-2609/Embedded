...
#define w_zerocycles    (((16000000/1000)*w_zeropulse          )/1000000)
#define w_onecycles     (((16000000/1000)*w_onepulse    +500000)/1000000)
#define w_totalcycles   (((16000000/1000)*w_totalperiod +500000)/1000000)
...
#define w_lowtime ((w1_nops+w_fixedlow)*1000000)/(160000001000)
#if w_lowtime>550
